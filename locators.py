...
ELEMENT_AVATAR_USER = (By.XPATH, "//svg[@class='svgSmall']")
ELEMENT_USERNAME_DISPLAY = (By.XPATH, "//h3[@class='profileText name']")
...
INPUT_AD_CONDITION = (By.CSS_SELECTOR, ".radioUnput_shell__Wtdwe label.h2")
